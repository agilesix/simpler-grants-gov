...
def test_nineteen_sf424_answers_do_not_reach_the_submission():
...
def test_the_submission_that_drops_them_is_still_valid(validator):
...
def test_a_fax_number_is_dropped_because_the_rule_reads_a_field_that_does_not_exist():
...
def test_the_country_the_form_offers_is_not_the_one_the_schema_declares(validator):
...
def test_a_funding_amount_the_form_accepts_cannot_be_submitted(validator, amount, facet, why):
    result = validator.validate_xml_for_form(
